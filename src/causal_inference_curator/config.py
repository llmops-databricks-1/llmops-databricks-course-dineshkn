"""Configuration management for Causal Inference Curator."""
...
class ProjectConfig(BaseModel):
    ...
    system_prompt: str = Field(
        default=(
            ...
            "causal inference concepts and research papers."
        ),
...
def load_config(config_path: str = "project_config.yml", env: str = "dev") -> Config:
    ...
    Returns:
        Config instance with project, model, vector_search, and chunking configs
    """
    ...
    # Extract project config for the specified environment
    project_config = ProjectConfig(**config_data[env])

    # Extract other configs (they're not environment-specific)
    model_config = ModelConfig(**config_data.get("model_config", {}))
    vector_search = VectorSearchConfig(**config_data.get("vector_search", {}))
